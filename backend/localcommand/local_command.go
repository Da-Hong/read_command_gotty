...
func (lcmd *LocalCommand) Write(p []byte) (n int, err error) {
	if p[0] == 13 {
		fmt.Println("writeInfo:" + lcmd.info)
		...
		if strings.HasPrefix(text, "27") || strings.HasPrefix(text, "pwd") || strings.HasPrefix(text, "exit") || strings.HasPrefix(text, "cd") || strings.HasPrefix(text, "ls") || strings.HasPrefix(text, "ps") || strings.HasPrefix(text, "less") || strings.HasPrefix(text, "tail") || strings.HasPrefix(text, "more") || strings.HasPrefix(text, "cat") {
